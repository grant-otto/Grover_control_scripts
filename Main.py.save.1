...
def main():
	...
	if ret:
		...
		alue = [int(vehicle.location.global_frame.lat),int(vehicle.location.global_frame.lon),int(vehicle.location.global_frame.alt)] #takes the gps data from dronekit
